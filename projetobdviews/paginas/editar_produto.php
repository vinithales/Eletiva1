...
<div class="container mt-5">
    ...
    <form method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="nome" value="<?= $produto['nome']?>" id="nome" class="form-control"  required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="preco" value="<?= $produto['preco']?>" id="preco" class="form-control" step="0.01"  required>
        </div>
        <div class="mb-3">
            <label for="estoque_minimo" class="form-label">Estoque Mínimo</label>
            <input type="number" name="estoque_minimo" value="<?= $produto['estoque_minimo']?>"  id="estoque_minimo" class="form-control"  required>
        </div>
        <div class="mb-3">
